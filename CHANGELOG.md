...
- reviewed the pi `0.70.0` changelog and confirmed the extension does not depend on the TypeBox migration surface, removed cwd-bound helpers, or stale post-session-switch objects, or changed terminal progress defaults
